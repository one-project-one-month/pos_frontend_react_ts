...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("text-start my-4 text-xl text-gray-900 dark:text-gray-400 underline", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle [&:has([role=checkbox])]:pr-0 dark:text-dark-tertiary", className)}
    {...props}
  />
))
