                ...
                <ul className="space-y-2 text-sm font-medium">
                    {/* <li>
                            <NavLink to="/" className={({ isActive, isPending }) =>
                                isPending ? "bg-red-100 flex items-center rounded-lg px-3 py-2 text-slate-900 hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700" : isActive ? "bg-blue-800" : ""}
                            >
                    ...
                    <li>
                        <NavLink to="/products" className={({ isActive }) =>
                            `flex items-center rounded-lg px-3 py-2 text-slate-900 hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700" ${isActive ? "bg-blue-800" : ""}`
                        }>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                // className="h-5 w-5"
